...
<div class="invierno">
  <div style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify; width:45%;">
    ...
    <p><br>
      ...
      <br>Es complicado dar un balance entre la ropa comoda y la ropa a la moda, nosotros tratando de dar ese balance creamos nuestras tres categorías donde seguramente encontrarás algo que se adapte a ti, a tus gustos y a tus necesidades.
...
<div class="vestidos">
  ...
  <div style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify; width:40%;">
    ...
    <p><br>
      ...
      <br>Queremos llegar a tener una tienda física donde puedas asistir con tu familia o amigos y tengas una atención digna de ti. <br><br>
